...
%%
function [SNR_value] = CWDAML_MQAM(rp)
...
save_loc = [pathname,filename,'_',num2str(M,'%u'),'-',rp.format,'_BR_',num2str(R,'%10.3G'),'_LLW_',num2str(laser_linewidth,'%10.3G'),'_FO_',num2str(frequency_offset,'%10.3G'),'_FL_',num2str(N,'%u'),'.mat'];
save(save_loc);
